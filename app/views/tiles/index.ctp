<div class="tiles index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('top_id');?></th>
			<th><?php echo $this->Paginator->sort('right_id');?></th>
			<th><?php echo $this->Paginator->sort('bottom_id');?></th>
			<th><?php echo $this->Paginator->sort('left_id');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $tile['Tile']['top_id']; ?>&nbsp;</td>
		<td><?php echo $tile['Tile']['right_id']; ?>&nbsp;</td>
		<td><?php echo $tile['Tile']['bottom_id']; ?>&nbsp;</td>
		<td><?php echo $tile['Tile']['left_id']; ?>&nbsp;</td>
