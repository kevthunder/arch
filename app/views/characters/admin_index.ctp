<div class="characters index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('total_hp');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $character['Character']['hp']; ?>&nbsp;</td>
		<td><?php echo $character['Character']['total_hp']; ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($character['User']['id'], array('controller' => 'users', 'action' => 'view', $character['User']['id'])); ?>
		</td>
		<td><?php echo $character['Character']['active']; ?>&nbsp;</td>
		<td><?php echo $character['Character']['created']; ?>&nbsp;</td>
		<td><?php echo $character['Character']['modified']; ?>&nbsp;</td>
		<td class="actions">
